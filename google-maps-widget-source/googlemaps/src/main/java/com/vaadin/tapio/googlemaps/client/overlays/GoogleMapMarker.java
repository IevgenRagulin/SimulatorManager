...
public class GoogleMapMarker implements Serializable {
	...
	private double orX = -1.0;
	private double orY = -1.0;
	private double anX = -1.0;
	private double anY = -1.0;
	...
	public void setOrigX(double originX) {
		this.orX = originX;
	}
	...
	public void setOrigY(double originY) {
		this.orY = originY;
	}

	public double getAnchX() {
		return anX;
	}

	public void setAnchX(double anchorX) {
		this.anX = anchorX;
	}

	public double getAnchY() {
		return anY;
	}

	public void setAnchY(double anchorY) {
		this.anY = anchorY;
	}
