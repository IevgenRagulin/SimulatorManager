...
public class PrimaryFlightDisplay extends com.vaadin.ui.AbstractJavaScriptComponent {
	...
	pfdStateBean = new PrimaryFlightDisplayStateBean(altitude, speed, roll, pitch, heading, truecourse, verticalspeed,
		resetpfd);
	...
	int newPitch = doubleToInt((Double) ((Property<?>) item.getItemProperty(SimulationPfdInfoCols.pitch.toString()))
		.getValue());
	int newHeading = doubleToInt((Double) ((Property<?>) item.getItemProperty(SimulationPfdInfoCols.heading.toString()))
		.getValue());
	...
	int newAltitude = doubleToInt((Double) ((Property<?>) item.getItemProperty(SimulationPfdInfoCols.altitude.toString()))
		.getValue());
	...
	float newVertSpeed = doubleToRoundedFloat((Double) ((Property<?>) item
		.getItemProperty(SimulationPfdInfoCols.verticalspeed.toString())).getValue());
     ...
     */
    private void setNewValues(int newRoll, int newPitch, int newHeading, int newTrueCourse, int newIas, int newAltitude,
	    float newVertSpeed) {
