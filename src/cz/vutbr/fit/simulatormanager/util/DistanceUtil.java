...
import cz.vutbr.fit.simulatormanager.simulatorcommunication.DatabaseUpdater;
...
public class DistanceUtil {
	...
	public static double distanceBetweenTwoPoints(double lat1, double lon1, double lat2, double lon2) {
		...
		double dist = Math.sin(DistanceUtil.deg2rad(lat1)) * Math.sin(DistanceUtil.deg2rad(lat2)) + Math.cos(DistanceUtil.deg2rad(lat1)) * Math.cos(DistanceUtil.deg2rad(lat2))
